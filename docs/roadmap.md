...
> 마지막 업데이트: 2026-05-05 (Phase 0.7.3 진입 — ADR 0003 §17 라운드 #7 / §18 라운드 #8 후속, 종목 3 종 069500+132030+329200)
...
| **Phase 0.7.3** | **진행 중 (2026-05-05 진입)** — 종목 다양화 (3 종, 정책 동일성, EQUAL default) | ADR 0003 §18 |
...
### 0.7.3 (진행 중, 2026-05-05 진입) — 종목 다양화
- 종목 3 종: 069500 + 132030 (KODEX 골드) + 329200 (TIGER 부동산인프라고배당)
- 채권 (214980) 대체 — 정책-자산 부정합 처방. 자산군 다각화
...
- 결정: ADR 0003 §18. 회고: `phase-0.7.3.md` (예정)
