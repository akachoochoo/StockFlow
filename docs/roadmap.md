...
> 마지막 업데이트: 2026-05-07 (sub-step 0.9.m / 0.9.2.a 완료 — ADR 0005 §8 박제 라운드 #14, Phase 0.9.2 정식 진입)
...
#### Phase 0.9.2 sub-step 매핑 (ADR 0005 §8.5 박제)
  ...
  * 0.9.2.b: `config/strategies-0.9.2.yaml` + 5 종 백테스트 실행
  * 0.9.2.c: 결과 분석 + ADR §9 박제
