...
> 마지막 업데이트: 2026-05-04 (Phase 0.7.2 진입 — ADR 0003 §15.5.1 / §16 후속)
...
| **Phase 0.7.2** | **진행 중 (2026-05-04 진입)** — 자본 배분 정책 비교 | ADR 0003 §16 |
| Phase 0.7.3 | 예정 — 종목 다양화 | (라운드 #7 또는 #8) |
...
### 0.7.2 (진행 중, 2026-05-04 진입) — 자본 배분 정책 비교
- 종목 유지 (069500 + 214980) — 변수 통제
- 후보: 균등 / 역변동성 (1/σ) / 정변동성 (σ)
- 게이트 baseline: H1 ≥ 15.6% / H2 ≥ +5.25% / H3 ≥ 0.33 (Phase 0.7.1 측정값)
- 결정: ADR 0003 §16. 회고: `phase-0.7.2.md` (예정)

### 0.7.3 (예정) — 종목 다양화
- 3 ~ 5 종목 / 정책-자산 부정합 처방
- 종목별 다른 정책 허용 여부 (ADR §7.3 후속)
