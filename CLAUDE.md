...
- Sub-step (ADR 0005 §1.12 + §3 합병 박제): 0.9.a (ADR 박제) ✅ → 0.9.b (CLAUDE.md
  ...
  0.9.l (게이트 판정 정식 박제 — ADR §7, 시나리오 C / 2/3 PASS) ✅ →
  **0.9.m (Phase 0.9.2 진입 결정 라운드 #14)**
...
*마지막 업데이트: 2026-05-07 (§14 — sub-step 0.9.l 완료 표기 갱신, ADR 0005 §7 박제 후속 — 시나리오 C / 게이트 2/3 PASS 정식 박제)*