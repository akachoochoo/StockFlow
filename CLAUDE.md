...
- Sub-step (ADR 0005 §8.5 박제): **0.9.2.a (ADR §8 박제 + CLAUDE.md/roadmap 갱신)** ✅ →
  0.9.2.b (yaml + 백테스트 실행) → 0.9.2.c (결과 분석 + ADR §9) → 0.9.2.d (회고
  `phase-0.9.2.md`) → 0.9.2.e (게이트 판정 — ADR §10) → 0.9.2.f (Phase 0.9
  시리즈 종료 결정 라운드 #15 + 시리즈 회고 `phase-0.9.md` + CLAUDE.md §16 갱신
  + Phase 1 trigger)
...
*마지막 업데이트: 2026-05-07 (§14 — sub-step 0.9.m / 0.9.2.a 완료, ADR 0005 §8 박제 라운드 #14 후속 — Phase 0.9.2 정식 진입)*