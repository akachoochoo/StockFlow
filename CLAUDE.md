...
- Sub-step (ADR 0005 §8.5 박제): 0.9.2.a (ADR §8 박제 + CLAUDE.md/roadmap 갱신) ✅
  ...
  → **0.9.2.d (회고 `phase-0.9.2.md`)** → 0.9.2.e (게이트 판정 — ADR §10) →
  0.9.2.f (Phase 0.9 시리즈 종료 결정 라운드 #15 + 시리즈 회고 `phase-0.9.md` +
  CLAUDE.md §16 갱신 + Phase 1 trigger)
...
*마지막 업데이트: 2026-05-08 (§14 — sub-step 0.9.2.c 완료, ADR 0005 §9 박제 후속, 자산군 분산 = H3 회복 충분 조건 일반화 박제)*