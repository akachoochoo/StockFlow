...
- Sub-step (ADR 0005 §1.12 + §3 합병 박제): 0.9.a (ADR 박제) ✅ → 0.9.b (CLAUDE.md
  ...
  + Phase 0.7.3 회귀 invariant — ADR 0005 §5, H1/H2/H3 PASS) ✅ → **0.9.i (백테스트
  실행)** → 0.9.j (결과 분석 + ADR) → 0.9.k (회고) → 0.9.l (게이트 판정) → 0.9.m
  (Phase 0.9.2 진입 결정)
...
*마지막 업데이트: 2026-05-07 (§14 — sub-step 0.9.h 완료 표기 갱신, ADR 0005 §5 박제 후속, Phase 0.7.3 회귀 invariant PASS)*